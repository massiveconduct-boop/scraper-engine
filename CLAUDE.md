...
- **Testing:** pytest 9.1.1, 336 unit+integration+chaos tests pass (1 skip, 0 error, as of round 26) + 12 live + load suite. Captcha/Camoufox live tests skipped in CI.
...
pytest tests/unit/ tests/integration/ tests/chaos/ -q     # 336 pass / 1 skip / 0 error (round 26)
