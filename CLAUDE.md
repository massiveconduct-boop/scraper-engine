...
Project identity, operating rules, and navigation. Currently at round 36 (`/v1/health` extended with informational daemon-liveness checks, closing round 35's open follow-up). Full round-by-round narrative, every open thread, every decision: `.claude/knowledge/technical-debt.md` (start there, not here — this file is navigation only). Source code is fully implemented — not blueprint phase.
...
- **Evolution history (round-by-round narrative moved out of this file in
  ...
  extended with informational daemon-liveness checks (round 36). Current design, topic-
