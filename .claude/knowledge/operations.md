...
3. **mypy not clean:** 23 known type findings in baseline (`tools/mypy-baseline.txt`). Ratchet prevents new errors; existing errors shrink via PR discipline. `--strict` is a future goal.
